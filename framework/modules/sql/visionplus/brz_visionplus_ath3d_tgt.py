...
class BrzVisionplusAth3dTgt:
    def __init__(self, params: dict):
        ...
        self.queries=[{
            ...
            {
                "name": "query_002_cleanse_and_derive",
                "sql": f"""
                    SELECT
                        ...
                        CAST('2026-02-01' AS DATE)    AS SRC_BUSINESS_DT
  ...
  # Example usage:
# queries = BrzVisionplusAth3dTgt(business_date).get_queries()